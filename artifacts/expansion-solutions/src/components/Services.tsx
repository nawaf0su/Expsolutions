...
export function Services({ t }: { t: T }) {
  return (
    <SectionWrapper id="services" className="bg-brand-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <span className="inline-block text-brand-teal text-sm font-semibold tracking-widest uppercase mb-3">
            {t.services.title}
          </span>
          <h2 className="text-3xl sm:text-4xl font-bold text-brand-navy">{t.services.title}</h2>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {t.services.items.map((service, i) => (
            ...
            >
              {/* Header */}
              <div className="bg-gradient-to-br from-brand-navy to-brand-navy-light p-6 relative overflow-hidden">
                <div className="absolute -top-6 -end-6 w-24 h-24 rounded-full bg-brand-teal/10" />
